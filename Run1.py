...
lines_edges = cv2.addWeighted(color_edges, 0.9, line_image, 2, 0) 
...
# Helper functions
def grayscale(test_images/solidWhiteRight.jpg):
	"""Applies the Grayscale transform
	This will return an image with only one color channel
	but NOTE: to see the returned image as grayscale
	you should call plt.imshow(gray, cmap='gray')"""
	return cv2.cvtColor(test_images/solidWhiteRight.jpg, cv2.COLOR_BGR2GRAY)
